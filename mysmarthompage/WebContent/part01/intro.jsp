...
<body>
	...
	<div>
		...
		<ol>
			...
			<li>이클립스
				<a href="https://eclipse.org/downloads/"></a>
			</li>
			<li>
				이클립스와 톰캣의 연동
			</li>
			...
			<li>
				Dynamic Wed Project 을 만들고 jsp파일 만들기
			</li>
		</ol>
	</div>
	<div>
		...
		<u1>
			<li>
				서블릿(Servlet) :Server + Applet 합성올 서버에서 실행되는 Applet이란 의미로<br />
	...
	<div>
		...
		<ul>
			<li>
				<a href="part01/go_method.do">메소드JPS로 이동</a>
			</li>
		</ul>
	</div>
</body>
